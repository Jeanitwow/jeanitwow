...
export default function ArticleListingTemplate(props: ArticleListingTemplateProps): React.ReactElement {
    ...
    const entities = pluralize(props.pageContext.entityName) ?? 'Статьи';

    return (
        <>
            <Seo title={`Все ${entities}`} useTitleTemplate={true} />
            <Page>
                <Section anchor="articleListing" heading={entities}>
                    <div className={classes.Filter}>
                        Фильтровать {entities.toLocaleLowerCase()} по категориям
